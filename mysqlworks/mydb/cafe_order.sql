...
from drink a, cafe_order b where a.drink_code = b.drink_code; 

-- 내부조인(join ~ on)
select a.drink_name, a.drink_code, b.order_no, b.order_cnt 
from drink a join cafe_order b on a.drink_code = b.drink_code; 
...
-- 주문이 없은 상품을 검색하세요
select a.drink_name '주문이 없는 상품', a.drink_code, b.order_no, b.order_cnt 
from drink a left join cafe_order b on a.drink_code = b.drink_code
